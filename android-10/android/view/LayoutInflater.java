...
/**
 * <li>该类是解析整个布局的起点，例如setContentView()也会调用该类解析整个布局</li>
...
public abstract class LayoutInflater {
     ...
     *         the inflated XML file.
     */
    //以如下参数为例： root 为null ， attachToRoot为false 。
    public View inflate(XmlPullParser parser, ViewGroup root, boolean attachToRoot) {
        synchronized (mConstructorArgs) {
            final AttributeSet attrs = Xml.asAttributeSet(parser);
            Context lastContext = (Context)mConstructorArgs[0];
            //mConstructorArgs属性最后会作为参数传递给View的构造函数 
            // createView方法中的return (View) constructor.newInstance(args);
            ...
            try {
                ...
                if (TAG_MERGE.equals(name)) {
                    ...
                    //创建该xml布局文件所对应的根View。通过反射加载View的实例对象  
                    View temp = createViewFromTag(name, attrs);

                    ViewGroup.LayoutParams params = null;
                    /*若inflate(R.layout.view,null);说明root等于null，那么params会为空，
                    params不会被赋值。
                    任何View树的顶层View被添加至窗口时，
                    ...
                    */
                    if (root != null) {
                        ...
                        //如果root!=null那么attachToRoot就为true
                        if (!attachToRoot) {
