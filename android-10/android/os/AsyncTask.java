...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    */
    ...
    //该类继承与callable类，该类是有返回结果的Runable
    ...
    线程来调用，也不会实例化这个常量.关于这个handler,默认asynctask都是从主线程中调用的,所以,这个Handler默认  
    获得了主线程的Looper,所以就能和主线程来交互. 
    
    Notes：假如你在一个子线程中构建了自己的Looper并使用Asynctask,  
    ...
    google没有考虑到这里，只是在文档中要求必须在主线程中调用*/
